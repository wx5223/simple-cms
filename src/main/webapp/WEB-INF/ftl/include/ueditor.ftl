...
<script type="text/javascript" charset="utf-8" src="${ctx}/resources/ueditor/ueditor.config.use.js"></script>
<script type="text/javascript" charset="utf-8" src="${ctx}/resources/ueditor/ueditor.all.js"> </script>
<script type="text/javascript" charset="utf-8" src="${ctx}/resources/ueditor/ueditor.parse.js"> </script>
