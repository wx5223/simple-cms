    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <p>Copyrights @ 2010-2015 jingdian.cn All Rights Reserved. 版权所有南京皇拓</p>
                <p>ICP备案号：苏ICP备XXXXXX号</p>
                <p>地址:南京市浦口区滨江大道1号明发滨江新城三期319栋801室025-66112305</p>
            </div>
        </div>
    </div>
</footer>
...
<script type="text/javascript"> jQuery(document).ready(function(){ $("#circletext").text(""); $(window).load(function() { $("#circle").fadeOut(400); $("#circle1").fadeOut(600); $("#circletext").text("").fadeOut(800); }); }); </script>
<style>
    /* 圆圈加载*/
