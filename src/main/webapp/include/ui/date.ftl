...
<#macro date    id=""    name=""    value="" begin="" end="" limit="30"  
	...
	class="form-control"	 style=""	readonly=""	validation=""   disabled=false	maxlength=""	minlength=""	 placeholder=""
	>
<div class="form-group ms-form-group">	
	<#include "control.ftl"/><#rt/>
   <div style="float:left;width:<#if single>200px<#else>250px</#if>;height:auto">
...
<script>
  var ${name}Set = {
    ...
    format: 'YYYY-MM-DD <#if time>hh:mm </#if>',
    separator: '至 ',
    locale: {
        applyLabel: '确认',
        cancelLabel: '取消',
